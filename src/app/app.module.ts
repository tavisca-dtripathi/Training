...
import { UniqueProductDirectiveComponent } from './components/directivecomponent/app.uniqueproductdirective.component';
import { ProductIdDirective } from './directives/app.product.directive';
...
@NgModule({
  declarations: [
    ...
    UniqueProductDirectiveComponent,
    ProductIdDirective
  ],
  imports: [
  ...
  bootstrap: [ UniqueProductDirectiveComponent]
})
